...
// Single source of truth in `shared` so server, typegen, and browser don't drift.
...
> {
  ...
  /** Column metadata for auto-rendered forms. Registered from generated typegen output. */
